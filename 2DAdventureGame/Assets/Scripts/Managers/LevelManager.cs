...
public class LevelManager : MonoBehaviour {
    ...
    {
        FloatingText.Show("Vous Avez Gagne!", "CheckPointText", new CenteredTextPositioner(0f));
    }
    ...
    {
        FloatingText.Show("Vous Avez Perdu!", "CheckPointText", new CenteredTextPositioner(.2f));
