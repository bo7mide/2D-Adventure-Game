...
public class AdvancedEnnemyAI : MonoBehaviour, ITakeDamage, ITakeEffect
{
    public float Speed;
    ...
    void Update()
    {
        ...
        foreach(Collider2D c in colliders)
        {
            ...
            if (playerProjectile != null && playerProjectile.Owner!=null && playerProjectile.Owner.GetComponent<Player>() != null)
            {
